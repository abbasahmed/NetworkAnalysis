 ...
 * </ul>
 * <p>
 * The first method returns true if standard input has more tokens. Each other
 * method skips over any input that is whitespace. Then, it reads the next token
 * and attempts to convert it into a value of the specified type. If it
 ...
 * <p>
 * <b>Using standard input.</b> Standard input is fundamental operating system
 * abstraction, on Mac OS X, Windows, and Linux. The methods in {@code StdIn}
 * are <em>blocking</em>, which means that they will wait until you enter input
 * on standard input. If your program has a loop that repeats until standard
 * input is empty, you must signal that the input is finished. To do so,
 * depending on your operating system and IDE, use either {@code <Ctrl-d>} or
...
public final class StdIn {
	 ...
	 *
	 * @return {@code true} if standard input has more input (including
	 *         whitespace); {@code false} otherwise
	 */
	 ...
	 * succeed. This method is functionally equivalent to
	 * {@link #hasNextLine()}.
	 *
	 * @return {@code true} if standard input has more input (including
	 *         whitespace); {@code false} otherwise
